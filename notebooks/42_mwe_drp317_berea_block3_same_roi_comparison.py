# %% [markdown]
# # MWE 42 - DRP-317 Berea ROI-300 map-30 same-ROI comparison
#
# This notebook repeats the DRP-317 Berea comparison with a `300^3` voxel image
...
output_dir = (
    ...
    / "notebooks"
    / "outputs"
    / "42_mwe_drp317_berea_roi300_map30_same_roi_comparison"
)
output_dir.mkdir(parents=True, exist_ok=True)
output_prefix = "drp317_berea_roi300_map30_same_roi"
...
permeability_map = permeability_map_from_porosity(
    ...
    metadata={
        "closure_note": "Kozeny-Carman coefficient map for same-ROI ROI-300 map-30 Berea comparison",
...
ax.set_title("DRP-317 Berea ROI-300 map-30 same-ROI comparison")
...
ax.set_title("DRP-317 Berea ROI-300 map-30 same-ROI solver wall time by axis")
ax.grid(True, axis="y", which="both", alpha=0.25)
ax.legend(fontsize=8, loc="center left", bbox_to_anchor=(1.02, 0.5), borderaxespad=0.0)
...
ax.set_title("DRP-317 Berea ROI-300 map-30 same-ROI equivalent permeability")
