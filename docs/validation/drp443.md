# DRP-443 Fracture-Network Validation Overview

This report summarizes the current `voids` validation workflow for the two
...
this dataset. This is a useful validation signal: the current extraction plus
closure setup is physically plausible but not yet directionally calibrated to
the paper-reported left-to-right permeability.
