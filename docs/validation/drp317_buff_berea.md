...
| ROI porosity [%] | 22.82 |
| Network absolute porosity [%] | 23.40 |
| Experimental permeability [mD] | 275.0 |
| Kx [mD] | 390.44 |
| Ky [mD] | 314.58 |
| Kz [mD] | 206.55 |
| Arithmetic mean permeability [mD] | 303.86 |
| Quadratic-mean permeability [mD] | 313.09 |
| Relative quadratic-mean error [%] | 13.85 |

![Buff Berea directional permeability](../assets/validation/drp317_buff_berea_directional.png)

## Interpretation

The current workflow predicts `Buff Berea` with a quadratic-mean permeability error of
`13.85%` relative to the Table 1 experimental reference.
