...
!!! warning "Rendered results need refresh"
    The DRP-317 notebook sources use the paper-reference `generic_poiseuille`
    conductance model for all extraction backends. Re-run the notebooks and
    refresh the exported tables/figures before treating the rendered numerical
    results below as current.
...
| Bentheimer | PoreSpy snow2 | 22.64 | 27.57 | 386.0 | 505.19 | 30.88 |
| Bentheimer | PREGO | 22.64 | 26.53 | 386.0 | 920.69 | 138.52 |
