...
into structured mesh files for downstream continuum workflows.
...
map definitions, Kozeny-Carman closure, export assumptions, and solver-facing
caveats, see [Porosity Maps](../porosity_maps.md).
